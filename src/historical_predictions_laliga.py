...
import event_adjustments_laliga as adj_engine
...
PREDICTIONS_DIR = BASE_DIR / "data" / "laliga" / "historical_predictions"
...
def main():
    print("=" * 70)
    print("[*] HISTORICAL PREDICTIONS LaLiga EA Sports (WALK-FORWARD + EVENT ADJUSTMENTS)")
    print("=" * 70)
    ...
    summary_path = REPORTS_DIR / "historical_adjustment_comparison_laliga.json"
