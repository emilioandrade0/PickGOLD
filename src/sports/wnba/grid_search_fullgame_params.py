...
PICK_PARAMS_FILE = SRC_ROOT / "data" / "wnba" / "models" / "pick_params.pkl"
REPORT_DIR = SRC_ROOT / "reports" / "wnba_param_search"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Grid search full-game decision params for WNBA.")
