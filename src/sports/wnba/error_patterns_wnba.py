...
REPORT_DIR = SRC_ROOT / "reports" / "wnba_error_patterns"
...
def run(date_from: str | None = None, date_to: str | None = None):
    ...
    print("WNBA error patterns report generated.")
    print(f"Summary: games={n_games} full_acc={full_acc:.4f} q1_acc={q1_acc:.4f}")
    print(f"Output folder: {REPORT_DIR}")


if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Analyze WNBA historical prediction error patterns.")
