...
ESPN_TO_NBA = {
    ...
    "WSH": "WAS", "UTAH": "UTA", "CHA": "CHA", "BKN": "BKN",
}
            ...
            try:
                ...
                if resp.status_code == 200:
                    ...
                    for event in filtered_events:
                        ...
                        h_abbr = ESPN_TO_NBA.get(home["team"]["abbreviation"], home["team"]["abbreviation"])
                        a_abbr = ESPN_TO_NBA.get(away["team"]["abbreviation"], away["team"]["abbreviation"])
                        game_id = str(event["id"])
                        ...
                        for tb in teams_box:
                            t_abbr = ESPN_TO_NBA.get(tb.get("team", {}).get("abbreviation"), tb.get("team", {}).get("abbreviation"))
...
def enrich_today_data(final_df):
    ...
    df_inj = fetch_nba_injury_report()
