...
mlb_hist.FEATURES_FILE = BASE_DIR / "data" / "triple_a" / "processed" / "model_ready_features_triple_a.csv"
mlb_hist.MODELS_DIR = BASE_DIR / "data" / "triple_a" / "models"
mlb_hist.HIST_DIR = BASE_DIR / "data" / "triple_a" / "historical_predictions"
mlb_hist.HIST_DIR.mkdir(parents=True, exist_ok=True)
mlb_hist.OUTPUT_DIR = BASE_DIR / "data" / "triple_a" / "walkforward"
...
# Triple-A tiene menos historial que MLB; usamos ventanas mas compactas.
...
if __name__ == "__main__":
    ...
    print(f"Triple-A: snapshots historicos generados: {files_built}")
