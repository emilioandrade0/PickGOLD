...
def main() -> None:
    run_step("data_ingest_liga_mx.py")
    run_step("feature_engineering_liga_mx.py")
    run_step("feature_engineering_liga_mx_v3.py")
    run_step("train_models_liga_mx.py")
    run_step("train_models_liga_mx_selective.py")
    run_step("historical_predictions_liga_mx.py")
    run_step("evaluate_baseline.py")
    run_step("predict_today_liga_mx.py")
    print("\n[OK] Liga MX full pipeline completed.")
