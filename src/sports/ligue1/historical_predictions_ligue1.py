...
import event_adjustments_ligue1 as adj_engine
...
PREDICTIONS_DIR = BASE_DIR / "data" / "ligue1" / "historical_predictions"
...
def main():
    print("=" * 70)
    print("[*] HISTORICAL PREDICTIONS ligue1 (WALK-FORWARD + EVENT ADJUSTMENTS)")
    print("=" * 70)
    ...
    summary_path = REPORTS_DIR / "historical_adjustment_comparison_ligue1.json"
